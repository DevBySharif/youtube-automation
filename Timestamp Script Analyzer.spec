...
a = Analysis(
    ...
    hiddenimports=(
        ...
        + [
            ...
            'voice_engine.image_planner',
            'image_engine',
            'image_engine.capabilities',
            'image_engine.base_provider',
            'image_engine.stub_provider',
            'image_engine.registry',
            'image_engine.cache',
            'image_engine.validator',
            'image_engine.queue_manager',
            'image_engine.config_manager',
            'image_engine.prompt_builder',
            'image_engine.templates',
            'image_engine.character_memory',
            'image_engine.location_memory',
            'image_engine.object_memory',
            'image_engine.history',
            'ui.voice_cloning_dialog',
            'ui.voice_library_dialog',
            'ui.advanced_voice_panel',
            'ui.history_dialog',
            'ui.dictionary_dialog',
            'ui.image_plan_dialog',
            'ui.image_queue_dialog',
            'ui.image_studio_panel',
            'ui.prompt_preview_dialog',
            'ui.image_gallery_dialog',
            'ui.image_history_dialog',
            'ui.main_window',
            'ui.script_panel',
            'ui.controls_panel',
            'ui.output_tabs',
